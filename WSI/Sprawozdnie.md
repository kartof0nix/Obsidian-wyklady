...
| Parametr | min         | śr          | std         | max         |
| -------- | ----------- | ----------- | ----------- | ----------- |
| mul= 0.05 | $1.96*10^8$ | $1.93*10^{16}$ | $1.35*10^{17}$ | $1.32*10^{18}$ |
| mul= 0.10 | $9.90*10^3$ | $6.35*10^{13}$ | $2.47*10^{14}$ | $1.43*10^{15}$ |
| mul= 0.50 | $2.77*10^2$ | $2.53*10^4$ | $8.65*10^4$ | $6.24*10^5$ |
| mul= 1.00 | $6.01*10^2$ | $2.65*10^4$ | $2.09*10^4$ | $1.15*10^5$ |
| mul= 2.00 | $8.41*10^3$ | $3.14*10^6$ | $3.59*10^6$ | $2.00*10^7$ |
